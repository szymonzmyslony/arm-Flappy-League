...
enum gameSizesAndPositions {
  ...
  BALL_SIZE = 64,
  MT_XGAP = 4,
  MT_NWIDTH = SURF_TIMING_TWIDTH,
  MT_WIDTH = 5 * MT_NWIDTH + 4 * MT_XGAP,
  MT_HEIGHT = 26,
  MT_OFFSET_X = WINDOW_WIDTH / 2 - MT_WIDTH / 2,
  MT_OFFSET_Y = 122,
  SCORE_XGAP = 10,
  SCORE_NWIDTH = SURF_SCORING_TWIDTH,
  SCORE_WIDTH = 2 * SCORE_NWIDTH + SCORE_XGAP,
  SCORE_HEIGHT = 80,
  SCORE_OFFSET_Y = MT_OFFSET_Y + MT_HEIGHT + 6,
  SCORE_MIDDLE_GAP = 24,
  SCORE1_OFFSET_X = WINDOW_WIDTH / 2 - SCORE_MIDDLE_GAP - SCORE_WIDTH,
  SCORE2_OFFSET_X = WINDOW_WIDTH / 2 + SCORE_MIDDLE_GAP,
  TITLE_WIDTH = 543,
  TITLE_HEIGHT = 90,
